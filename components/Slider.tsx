...
const Slider = ({ anime, loading = false }: Props) => {
  ...
  return (
    <div className="relative w-full h-[40vw] shadow-inner-[0px_-15px_13px_0px_rgba(0,0,0,1)] mb-[40px]">
      {!loading ? (
        ...
        <div className="blur_div bg-slate-500/50 animate-pulse absolute w-full h-full"></div>
      )}
      <div className="outer h-[calc(40vw+100px)] w-full p-[60px_15px_5px_15px] md:p-[60px_80px_25px_80px] backdrop-blur-sm">
        <div
          className={`slider h-full w-full relative rounded-[20px] hover:shadow-sm hover:shadow-[red] active:translate-y-1 ${
            loading
